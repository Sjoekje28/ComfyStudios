...
public class MEAcurracy : MonoBehaviour
{
    ...
    public GameObject tavernPuzzle;
    public GameObject pathPuzzle;
    public GameObject bridgePuzzle;
    public GameObject murderPuzzle;
    public GameObject carriagePuzzle;
    ...
    void Start()
    {
        ...
        accuracyBar.SetMaxAccuracy(MaxAccuracy);
...
private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.name == ("VictimBridge"))
        {
            bridgePuzzle.SetActive(true);
            setUpWordPuzzle();
            Destroy(other);
        }
        if (other.name == ("VictimMurder"))
        {
